...
public class BaseLDVisitPresenter implements BaseLDVisitContract.Presenter, BaseLDVisitContract.InteractorCallBack {

    protected WeakReference<BaseLDVisitContract.View> view;
    protected BaseLDVisitContract.Interactor interactor;
    protected MemberObject memberObject;

    public BaseLDVisitPresenter(MemberObject memberObject, BaseLDVisitContract.View view, BaseLDVisitContract.Interactor interactor) {
    ...
    @Override
    public void preloadActions(LinkedHashMap<String, BaseLDVisitAction> map) {
        if (view.get() != null)
