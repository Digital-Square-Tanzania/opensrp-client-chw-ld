...
import org.smartregister.chw.ld.util.ConfigHelper;
...
public class BaseLDRegisterFragmentModel implements LDRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(LDLibrary.getInstance().context().applicationContext());
    }
