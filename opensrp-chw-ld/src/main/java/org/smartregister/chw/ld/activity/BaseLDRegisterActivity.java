...
import org.smartregister.chw.ld.listener.LDBottomNavigationListener;
...
public class BaseLDRegisterActivity extends BaseRegisterActivity implements LDRegisterContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FORM_NAME = getIntent().getStringExtra(Constants.ACTIVITY_PAYLOAD.LD_FORM_NAME);
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseLDRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseLDRegisterActivity.class);
    ...
    public List<String> getViewIdentifiers() {
        return Arrays.asList(Constants.CONFIGURATION.LD_CONFIRMATION);
    }
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new LDBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseLDRegisterPresenter(this, new BaseLDRegisterModel(), new BaseLDRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseLDRegisterFragment();
    }
    ...
    @Override
    public LDRegisterContract.Presenter presenter() {
        return (LDRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = LDJsonFormUtils.fields(form, Constants.STEP_ONE);
...
//                process ld form
    ...
    public void startClientProcessing() {
        try {
            ...
            LDUtil.getClientProcessorForJava().processClient(LDUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
