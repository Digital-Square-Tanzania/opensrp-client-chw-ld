...
public class BaseLDRegisterFragment extends BaseRegisterFragment implements LDRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        LDRegisterProvider LDRegisterProvider = new LDRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.ld));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public LDRegisterFragmentContract.Presenter presenter() {
        return (LDRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseLDRegisterFragmentPresenter(this, new BaseLDRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseLDProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
