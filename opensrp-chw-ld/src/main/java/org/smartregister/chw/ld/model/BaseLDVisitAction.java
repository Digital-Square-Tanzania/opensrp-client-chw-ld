...
import org.smartregister.chw.ld.fragment.BaseVisitFragment;
 ...
 */
public class BaseLDVisitAction {
    ...
    private BaseLDVisitAction(Builder builder) throws ValidationException {
        ...
        this.ldVisitActionHelper = builder.ldVisitActionHelper;
    ...
    private void initialize() {
        try {
            ...
            if (ldVisitActionHelper != null) {
                ldVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = ldVisitActionHelper.getPreProcessed();
                ...
                String sub_title = ldVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = ldVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        ldVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = ldVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = ldVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = ldVisitActionHelper.postProcess(jsonPayload);
        }

        ldVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public LDVisitActionHelper getLDVisitActionHelper() {
        return ldVisitActionHelper;
    }

    public void setLDVisitActionHelper(LDVisitActionHelper ldVisitActionHelper) {
        this.ldVisitActionHelper = ldVisitActionHelper;
    }
    ...
    public interface LDVisitActionHelper {
    ...
    public static class Builder {
        ...
        public Builder withHelper(LDVisitActionHelper ldVisitActionHelper) {
            this.ldVisitActionHelper = ldVisitActionHelper;
            return this;
        }
