...
@PrepareForTest(BaseLDRegisterPresenter.class)
public class BaseTestRegisterPresenterLD {
    @Mock
    protected BaseLDRegisterPresenter baseLDRegisterPresenter;

    @Mock
    protected LDRegisterContract.Interactor interactor;
    @Mock
    protected LDRegisterContract.Model model;
    @Mock
    protected LDRegisterContract.View baseView;
    private BaseLDRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseLDRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseLDRegisterPresenter, "getView"));
    }
